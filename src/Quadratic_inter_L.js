...
function Quadratic_inter_P() {
    ...
    let [getaFX2, setgetaFX2] = useState()
      ...
      useEffect(() => {
        axios.get("http://localhost:3001/api/users/showquainla").then(res => {
    ...
    const trap = () => {
        ...
        c0 = ((x2-x)*(x1-x))/((x2-x0)*(x1-x0))

        c1 = ((x2-x)*(x0-x))/((x2-x1)*(x0-x1))

        c2 = ((x1-x)*(x0-x))/((x1-x2)*(x0-x2))
        ...
        return(
                ...
                <div className = "App">
                    ...
                    <div className = "up-extext">
                        ...
                        <h1> Quadratic Interpolation (Lagrange) </h1>     
                    ...
                    <div className = "App-table">
                      ...
                      <Table style={{ marginTop: 30 }} dataSource={datashow}>
                        ...
                        <Column title="L0" dataIndex="c0" key="c0" />
                        <Column title="L1" dataIndex="c1" key="c1" />
                        <Column title="L2" dataIndex="c2" key="c2" />
...
export default Quadratic_inter_P;